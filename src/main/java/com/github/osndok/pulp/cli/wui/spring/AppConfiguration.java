package com.github.osndok.pulp.cli.wui.spring;
...
@Configuration
@ComponentScan({ "com.github.osndok.pulp.cli.wui" })
    ...
    public ServletContextInitializer initializer() {
        return new ServletContextInitializer() {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "com.github.osndok.pulp.cli.wui");
                servletContext.setInitParameter("tapestry.development-modules", "com.github.osndok.pulp.cli.wui.services.DevelopmentModule");
